...
# This needs to be above your function so the decorator can add it to a list for functional tests
...
# Also have the 'config' parameter within the function definition, this represents the main.json
def A_NAME_THAT_PERTAINS_TO_YOUR_SERVICE_TEST(config):
    ...
    #     logging.warning("Looks like your service failed because the service is actually not working. Git Gud!: {}".format(e))
    # except Exception as e:
    #     logging.exception("Oh no! you divided by 0: {}".format(e))
    #

    # Have logic in your code to determine if the service is working
    # then return a 0 or 1
